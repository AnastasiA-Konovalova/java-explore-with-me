...
public class AdminCommentServiceImpl implements AdminCommentService {
    ...
    @Override
    public List<CommentDto> getCommentsByConditions(List<Long> users, List<Long> events, List<String> status, String rangeStart,
                                                    String rangeEnd, Long from, Long size) {
        Specification<Comment> specification = CommentSpecifications.filterCommentConditionals(users, events, status,
                rangeStart, rangeEnd);
